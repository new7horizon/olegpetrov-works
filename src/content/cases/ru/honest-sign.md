...
result: |
  ...
  Завод уложился в сроки «Честного знака» без потери производства и получил рабочую, поддерживаемую систему, которую ведёт самостоятельно.
delivered:
  - "Маркировка встроена в действующие линии разных производителей без остановки производства"
  - "Принтеры VideoJet и LetsMark, камеры Datalogic и Cognex на существующих машинах"
  - "Новое полевое питание, управляемая сеть и сервер с отчётом в государственную систему"
